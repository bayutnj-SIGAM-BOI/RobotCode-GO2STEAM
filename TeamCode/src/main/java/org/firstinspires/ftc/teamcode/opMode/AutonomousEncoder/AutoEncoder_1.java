...
@Autonomous(name = "Auto_1", group = "Go2Steam")
public class AutoEncoder_1 extends LinearOpMode {
...
//        Code Here
        ...
        driveEncoders(1500, 1500, 0.70, 3);
        driveEncoders(-25, 25, 0.50, 1);
        ThreeArtifactShooters();
        driveEncoders(-50, -50, 0.60, 2);
        sleep(2500);
        driveEncoders(50, 50, 0.60, 2);
        ThreeArtifactShooters();
